...
const CreateChurch = ({ showFlashFunc }) => {
  ...
  const createChurch = async () => {
      ...
      try {
        let {response, data} = await customFetcher("congregation/add", {body: JSON.stringify(body), 
          "method": "POST"})
    ...
    return ( 
      ...
      <div className="w-64 sm:w-96 m-auto rounded-3xl">
        <div className="w-11/12 m-auto p-2">
          ...
          <h1 className="text-center text-3xl font-semibold text-white">Create Church</h1>
        </div>
        <div className='w-11/12 m-auto h-56 overflow-auto pb-3'>
            ...
            <input type="text" placeholder="Church name" className="w-10/12 h-11 px-2
            ...
            <input type="text" placeholder="Church head" className="w-10/12 h-11 px-2
            bg-white border-l-2 focus:border-2 focus:border-gray-900 focus:outline-0 rounded-md"
            onChange={(e) => { setChurchHead(e.target.value) }}/>
            </div>
            <div className="w-11/12 bg-white m-auto mt-6 flex justify-end shadow-gray-900 shadow-sm
            hover:shadow-md hover:shadow-gray-900 rounded-md">
            <div className="w-2/12 text-gray-900 text-center text-xl pt-2 rounded-md">
            ...
            <input type="text" placeholder="Assistant church head" 
            className="w-10/12 h-11 px-2
            bg-white border-l-2 focus:border-2 focus:border-gray-900 focus:outline-0 rounded-md"
            onChange={(e) => { setAssChurchHead(e.target.value) }}/>
            </div>
            <div className="w-11/12 bg-white m-auto mt-6 flex justify-end shadow-gray-900 shadow-sm
            hover:shadow-md hover:shadow-gray-900 rounded-md">
            <div className="w-2/12 text-gray-900 text-center text-xl pt-2 rounded-md">
            ...
            <input type="date" placeholder="Year founded" 
            className="w-10/12 h-11 px-2
            bg-white border-l-2 focus:border-2 focus:border-gray-900 focus:outline-0 rounded-md"
        ...
        shadow-gray-900 shadow-sm hover:shadow-md hover:shadow-gray-900">
          ...
          hover:bg-yellow-700"
          onClick={() => { createChurch() }}>Create Church</button>
        </div>
      </div>
    </div>
     );
